...
protected:
	...
	CPanelAnimationVarAliasType( int, m_iScoreWidth, "score_width", "0", "proportional_int" );
	CPanelAnimationVarAliasType( int, m_iKillsWidth, "kills_width", "0", "proportional_int" );
