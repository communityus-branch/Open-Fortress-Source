...
public:
	...
	struct LevelHeader_t
	{
		...
		int				m_iMercenaryWins;									// # of red team wins
		...
		int				m_iMercenarySuddenDeathWins;						// # of blue team wins during sudden death
		...
		void Accumulate( LevelHeader_t &other )
		{
			...
			m_iMercenaryWins += other.m_iMercenaryWins;
			...
			m_iMercenarySuddenDeathWins += other.m_iRedSuddenDeathWins;
		}
	};
