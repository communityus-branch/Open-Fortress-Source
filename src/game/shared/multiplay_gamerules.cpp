...
ConVar mp_waitingforplayers_cancel( "mp_waitingforplayers_cancel", "1", FCVAR_GAMEDLL, "Set to 1 to end the WaitingForPlayers period." );
...
ConVar of_disable_waitingforplayers( "of_disable_waitingforplayers", "0", FCVAR_GAMEDLL, "Disable WaitingForPlayers" );
