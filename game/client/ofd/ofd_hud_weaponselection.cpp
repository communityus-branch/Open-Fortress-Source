...
//
// Purpose: Half-Life 2 weapon selection moddified for OpenFortress DM
//
//=============================================================================//
...
ConVar hud_showemptyweaponslots( "hud_showemptyweaponslots", "0", FCVAR_NONE, "Shows slots for missing weapons when recieving weapons out of order" );
...
//	if ( bSelected )
	{
		...
		if (bSelected)
			...
			ty += boxTall / 2 - surface()->GetFontTall(m_hTextFont) / 2;
