...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY ( ACT_VM_PRIMARYATTACK_CRIT );
...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY( ACT_MERC_STAND_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCH_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RUN_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCHWALK_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_SWIM_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_STAND_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_CROUCH_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_SWIM_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_STAND_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_CROUCH_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_SWIM_SMG );

	REGISTER_SHARED_ACTIVITY( ACT_MERC_STAND_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCH_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RUN_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCHWALK_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_SWIM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_STAND_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_CROUCH_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_SWIM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_STAND_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_CROUCH_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_SWIM_PISTOL );

	REGISTER_SHARED_ACTIVITY( ACT_MERC_STAND_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCH_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RUN_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCHWALK_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_SWIM_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_STAND_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_CROUCH_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_SWIM_KNIFE );

	REGISTER_SHARED_ACTIVITY( ACT_MERC_STAND_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCH_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RUN_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCHWALK_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_SWIM_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_STAND_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_CROUCH_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_SWIM_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_STAND_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_STAND_LOOP_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_STAND_END_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_CROUCH_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_CROUCH_LOOP_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_CROUCH_END_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_SWIM_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_SWIM_LOOP_SCATTERGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_SWIM_END_SCATTERGUN );
