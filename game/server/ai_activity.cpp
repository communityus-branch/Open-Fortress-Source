...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_SMG );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_SMG );

	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_PISTOL );

	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_KNIFE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_KNIFE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_KNIFE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_KNIFE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_KNIFE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_KNIFE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_KNIFE );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_KNIFE );

	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_LOOP_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_END_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_LOOP_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_END_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_LOOP_SCATTERGUN );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_END_SCATTERGUN );
}
