...
class CHL2WeaponPistol : public CBaseHLCombatWeapon
{
	DECLARE_DATADESC();

public:
	DECLARE_CLASS( CHL2WeaponPistol, CBaseHLCombatWeapon );
...
IMPLEMENT_SERVERCLASS_ST(CHL2WeaponPistol, DT_HL2WeaponPistol)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_pistol, CHL2WeaponPistol );
PRECACHE_WEAPON_REGISTER( weapon_pistol );

BEGIN_DATADESC( CHL2WeaponPistol )
...
// Output :
//-----------------------------------------------------------------------------
void CHL2WeaponPistol::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	switch( pEvent->event )
	{
